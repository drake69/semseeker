test_that("log-event", {
  ...
  session_log <- read.table(file.path(ssEnv$session_folder, "session_output.log"), sep = "\t", header = TRUE, quote = "")
  ...
  session_log_closed <- read.table(file.path(ssEnv$session_folder, "session_output.log"), sep = "\t", header = TRUE, quote = "")
