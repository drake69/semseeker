#' init environment
#'
#' @param resultFolderData where result of semseeker will bestored
...
init_env <- function(resultFolder, maxResources = 90)
{
  ...
  resultFolderDataChart  <-    dir_check_and_create(resultFolderData, "Chart")
  resultFolderDataInference  <-    dir_check_and_create(resultFolderData, "Inference")
  resultFolderDataEuristic  <-  dir_check_and_create(resultFolderData,"Euristic")
