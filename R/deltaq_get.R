...
deltaq_get <- function(resultPopulation){
  ...
  # must use keys_markers_figures_default because the selected marker could exclude deltas which is basic for deltaq
  ...
  log_event("DEBUG: ", format(Sys.time(), "%a %b %d %X %Y"), " Finished DELTAQ multiple annotated file!")
