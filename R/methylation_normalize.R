...
#     utils::write.table(normalizedData, paste(normalizationDataFolder, "/CHAMP_Normalization_by_", methodNormalization, "/", "Normalized_Data.txt", sep = ""), sep = "\t", row.names = TRUE)
#
#     #
...
#     utils::write.table(normalizedData2, paste(normalizationDataFolder, "/CHAMP_Normalization_by_", methodNormalization, "/", "Normalized_Data_2.txt", sep = ""), sep = "\t", row.names = TRUE)
#
