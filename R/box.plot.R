box.plot <- function(dataFrameToPlot, independent_variable,dependent_variable, transformation, family_test, samples_sql_condition="", area, subarea)
{
    ...
    filename  =  file_path_build(chartFolder,toupper(c("BOX_PLOT",family_test,as.character(transformation), independent_variable,"Vs", dependent_variable,area, subarea)),ssEnv$plot_format)
    if(!file.exists(filename))
    {
      ...
      filename  =  file_path_build(chartFolder,
        toupper(c("VIOLIN_PLOT",family_test,as.character(transformation), independent_variable,"Vs", dependent_variable,area, subarea)),ssEnv$plot_format)
