...
#' 3: genomic area: gene body, gene tss1550, gene whole, gene tss200, gene exonbnd  (includes 1 and 2)
...
#' @param maxResources percentage of max syste'ms resource to use
#'
#' @return
#' @export
#'
