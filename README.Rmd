...
install.packages(c("doFuture", "FactoMineR", "factoextra", "FSA", "fst", "future", "future.apply", "ggplot2", "gridExtra", "gtools", "Hmisc", "lqmm", "progressr", "reshape2", "zoo", "VennDiagram", "effsize", "pwr", "combinat", "philentropy", "parallelly", "knitr", "lmtest", "usethis","wordcloud","WebGestaltR","sqldf","effsize",
"pwr","philentropy","caret","openai","glmnet"))


<!-- install.packages("~/Documents/Progetti_Sviluppo/semseeker_0.10.15.tar.gz", repos = NULL, type = "source") -->
